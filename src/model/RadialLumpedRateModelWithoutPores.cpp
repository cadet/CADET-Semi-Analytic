...
#include "model/RadialLumpedRateModelWithoutPores.hpp"
...
/**
 * @brief Creates a RadialLumpedRateModelWithoutPores
 */
RadialLumpedRateModelWithoutPores::RadialLumpedRateModelWithoutPores(int unitOpIdx)
	: LumpedRateModelWithoutPores(unitOpIdx), _flowDirection(1)
{
}

RadialLumpedRateModelWithoutPores::~RadialLumpedRateModelWithoutPores() CASEMA_NOEXCEPT
{
}
 ...
 */
bool RadialLumpedRateModelWithoutPores::configure(io::IParameterProvider& paramProvider)
{
	LumpedRateModelWithoutPores::configure(paramProvider);
...
void RadialLumpedRateModelWithoutPores::setVelocityFromFlowRate(mpfr::mpreal const* in)
{
...
{
	const std::function<UnitOperation*(int)> f = [](int uoId) { return new RadialLumpedRateModelWithoutPores(uoId); };
	models[RadialLumpedRateModelWithoutPores::identifier()] = f;
	models["rLRM"] = f;
}

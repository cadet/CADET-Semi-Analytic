...
#ifndef LIBCASEMA_FILEIO_HPP_
#define LIBCASEMA_FILEIO_HPP_
...
public:
	IReaderCapabilities() { }
	virtual ~IReaderCapabilities() CASEMA_NOEXCEPT { }
...
public:
	IWriterCapabilities() { }
	virtual ~IWriterCapabilities() CASEMA_NOEXCEPT { }
...
public:
	...
	virtual ~INavigationCapabilities() CASEMA_NOEXCEPT { }
...
public:
	IFileIO() { }
	virtual ~IFileIO() CASEMA_NOEXCEPT { }

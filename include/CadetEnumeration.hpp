...
#ifndef CASEMA_CADETENUMERATION_HPP_
#define CASEMA_CADETENUMERATION_HPP_
...
inline void s2e(const std::string& name, ChromatographyType& enum_ret)
{
	...
	throw std::range_error("No enum entry for given chromatography type \"" + name + "\"!");
}
...
inline void s2e(const std::string& name, AdsorptionType& enum_ret)
{
	...
	throw std::range_error("No enum entry for given adsorption type \"" + name + "\"!");
}
...
inline void s2e(const std::string& name, ReconstructionType& enum_ret)
{
	...
	throw std::range_error("No enum entry for given reconstruction type \"" + name + "\"!");
}
...
inline void s2e(const std::string& name, ParticleDiscType& enum_ret)
{
	...
	throw std::range_error("No enum entry for given particle discretization type \"" + name + "\"!");
}
...
inline void s2e(const std::string& name, ParameterName& enum_ret)
{
	...
	throw std::range_error("No enum entry for given parameter name \"" + name + "\"!");
}
...
inline void s2e(const std::string& name, GroupName& enum_ret)
{
	...
	throw std::range_error("No enum entry for given group name \"" + name + "\"!");
}
...
#endif /* CASEMA_CADETENUMERATION_HPP_ */
